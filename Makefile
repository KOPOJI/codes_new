...
# Project:  codes.pro
# Template: subdirs
# Command: /usr/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile codes.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = codes1.0.0
DISTDIR = /home/kopoji/codes/.tmp/codes1.0.0
SUBTARGETS    =  \
		sub-helpers \
		sub-models \
		sub-views \
...
sub-helpers-qmake_all:  FORCE
	...
	cd helpers/ && $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd helpers/ && $(MAKE) -f Makefile qmake_all
sub-helpers: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
...
sub-helpers-all-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-helpers-all: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-helpers-clean-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-helpers-clean: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-helpers-distclean-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-helpers-distclean: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-helpers-install_subtargets-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-helpers-install_subtargets: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-helpers-uninstall_subtargets-ordered: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-helpers-uninstall_subtargets: FORCE
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-models-qmake_all: sub-helpers-qmake_all FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd models/ && $(MAKE) -f Makefile qmake_all
sub-models: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
...
sub-models-all-ordered: sub-helpers-all-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-models-all: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-models-clean-ordered: sub-helpers-clean-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-models-clean: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-models-distclean-ordered: sub-helpers-distclean-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-models-distclean: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-models-install_subtargets-ordered: sub-helpers-install_subtargets-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
...
sub-models-uninstall_subtargets-ordered: sub-helpers-uninstall_subtargets-ordered  FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-models-uninstall_subtargets: FORCE
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-views-qmake_all: sub-models-qmake_all FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd views/ && $(MAKE) -f Makefile qmake_all
sub-views: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
...
sub-views-all-ordered: sub-models-all-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-views-all: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-views-clean-ordered: sub-models-clean-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-views-clean: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-views-distclean-ordered: sub-models-distclean-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-views-distclean: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-views-install_subtargets-ordered: sub-models-install_subtargets-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-views-install_subtargets: FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-views-uninstall_subtargets-ordered: sub-models-uninstall_subtargets-ordered  FORCE
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
...
sub-controllers-qmake_all: sub-views-qmake_all FORCE
	...
	cd controllers/ && $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd controllers/ && $(MAKE) -f Makefile qmake_all
sub-controllers: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
...
sub-controllers-all-ordered: sub-views-all-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-controllers-all: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-controllers-clean-ordered: sub-views-clean-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-controllers-clean: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-controllers-distclean-ordered: sub-views-distclean-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-controllers-distclean: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-controllers-install_subtargets-ordered: sub-views-install_subtargets-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
...
sub-controllers-uninstall_subtargets-ordered: sub-views-uninstall_subtargets-ordered  FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-controllers-uninstall_subtargets: FORCE
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall

Makefile: codes.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		codes.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile codes.pro
...
sub-helpers-check_ordered:
	@test -d helpers/ || mkdir -p helpers/
	cd helpers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/helpers/helpers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
sub-models-check_ordered: sub-helpers-check_ordered 
	@test -d models/ || mkdir -p models/
	cd models/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/models/models.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
sub-views-check_ordered: sub-models-check_ordered 
	@test -d views/ || mkdir -p views/
	cd views/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/views/views.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
sub-controllers-check_ordered: sub-views-check_ordered 
	@test -d controllers/ || mkdir -p controllers/
	cd controllers/ && ( test -e Makefile || $(QMAKE) /home/kopoji/codes/controllers/controllers.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
